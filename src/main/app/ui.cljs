  ...
  (dom/svg {:width "100%"
    ...
    (dom/g
      (dom/path {:style {"fill" "none",
                 ...
                 :d (graphics/translate-path-str orig-path
                      {:y-translation -130.67721})}))))
  ...
  {:query [:room/id
   ...
   :css [[:.basic-style
         ...
         [:$wormhole-activated-animation
          {:animation "activated 2s infinite linear"}]
